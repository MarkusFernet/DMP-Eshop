# Generated by Django 4.1.3 on 2023-03-20 17:36
    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('regular_price', models.DecimalField(decimal_places=0, error_messages={'name': {'max_length': 'The price must be between 0 and 9999.'}}, help_text='Maximum 9999', max_digits=4, verbose_name='Regular price')),
                ('discount_price', models.DecimalField(decimal_places=0, error_messages={'name': {'max_length': 'The price must be between 0 and 9999.'}}, help_text='Maximum 9999', max_digits=4, verbose_name='Discount price')),
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('alt_text', models.CharField(blank=True, default='Responsive image', help_text='Please add alternative text', max_length=255, null=True, verbose_name='Alternative text')),
